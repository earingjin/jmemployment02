...
export default function App() {
  return <main>
    <header className="topbar"><a className="brand" href="#top" aria-label="홈으로"><img src={jmCareerLogo} alt="제이엠커리어 고용서비스" /></a><nav><a href="#benefit">구직수당 안내</a><a href="#process">신청 방법</a><a href="#faq">자주 묻는 질문</a></nav><button className="login">로그인</button><button className="menu" aria-label="메뉴 열기"><Menu size={22} /></button></header>
